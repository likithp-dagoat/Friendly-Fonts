...
Copy this ENTIRE value (WITHOUT the quotes - Vercel will handle quotes automatically):
```
...
**Important Notes:**
- **DO NOT include quotes** - Vercel handles quotes automatically
- Keep all the `\n` characters exactly as shown (don't replace them with actual line breaks)
